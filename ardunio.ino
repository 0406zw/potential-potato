 ...
 * 
*/
#define SSID        "jiaodage" //改为你的热点名称, 不要有中文
#define PASSWORD    "99818864"//改为你的WiFi密码Wi-Fi密码
#define DEVICEID    "577406442" //OneNet上的设备ID
String apiKey = "ZMhNj5IuOD2x13NbZUD8vF51v4A=";//与你的设备绑定的APIKey
